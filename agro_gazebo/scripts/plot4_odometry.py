...
class OdomSubscriber(Node):
    def __init__(self):
        ...
        self.gps_line, = self.ax.plot([], [], label="GPS Filtered (/gps/filtered)", color="orange")
    ...
    def gps_filtered_callback(self, msg):
        # Extraer coordenadas de /gps/filtered
    ...
    def update_plot(self, frame):
        ...
        self.gps_line.set_data(self.gps_x, self.gps_y)

        return self.local_line, self.sim_line, self.robot_agro_line, self.global_line, self.gps_line
